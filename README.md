...
| [matrix-rain-view](https://github.com/boy-offi9-inc/matrix-rain-view) | Configurable "Matrix digital rain" effect as a real, drop-in Android View — delta-time animation, glow, custom glyph sets, proper lifecycle. No toy demo. | Kotlin | ⭐ 1 |
